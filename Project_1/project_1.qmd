...
title = "Number of Jareds born in each year w/ 1997 highlighted"
...
```{python}
title = "Number of Jareds born was greater than the number of Jareds born in 1997"
...
# print(new_rule1)
my_name_chart3 = alt.Chart(new_rule1, title=title).mark_circle(color="blue", size=80).encode(
    x = 'year',
    y = 'Total',
).interactive()

title = "Number of Jareds born was greater than the number of Jareds born in 1997"
(my_name_chart1 + my_name_chart2 + my_name_chart3).properties(title=title)
...
title = "Number of Brittanys born in each year w/ peak highlighted"
...
title = "Brittanys Born per Year (>10,000 births)"
(my_name_chart1 + my_name_chart2 + my_name_chart3).properties(title=title)
```
...
title = "Brittanys Born During Britney Spears' Debut"
(my_name_chart1 + my_name_chart2 + my_name_chart3).properties(title=title)
...
```{python}
title = "Exploring the Popularity of the Name Brittany: Births during Britney Spears' Debut and Brittanys Born per Year (>10,000 births)"
(my_name_chart1 + my_name_chart2 + my_name_chart3).properties(title=title)
```
...
title = "Trends of Popular Names (Mary, Martha, Peter, Paul) in the 20th Century"

(mary_name_chart + mary_name_chart2 + martha_name_chart + martha_name_chart2
+ peter_name_chart + peter_name_chart2 + paul_name_chart + paul_name_chart2).properties(title=title)
...
title = "Trend of the Name Leia and Highlight on Year of Star Wars Release (1980)"
(movie_name_chart + movie_name_chart2).properties(title=title)
```
