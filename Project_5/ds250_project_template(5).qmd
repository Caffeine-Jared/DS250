...
```{python}
X = df.drop(['household_income', 'target'], axis=1)
...
#Spent forever tryign to make this work and still have no idea how it is supposed to work... So please give some coaching tips!
```
